...
(require __DIR__.'/App_KernelDevDebugContainer.php')->set(\ContainerXaSGAQg\App_KernelDevDebugContainer::class, null);
require __DIR__.'/ContainerXaSGAQg/EntityManagerGhostEbeb667.php';
require __DIR__.'/ContainerXaSGAQg/RequestPayloadValueResolverGhost3590451.php';
require __DIR__.'/ContainerXaSGAQg/ProfilerProxy0a5fddb.php';
require __DIR__.'/ContainerXaSGAQg/getWebProfiler_Controller_RouterService.php';
require __DIR__.'/ContainerXaSGAQg/getWebProfiler_Controller_ProfilerService.php';
require __DIR__.'/ContainerXaSGAQg/getWebProfiler_Controller_ExceptionPanelService.php';
require __DIR__.'/ContainerXaSGAQg/getValidator_WhenService.php';
require __DIR__.'/ContainerXaSGAQg/getValidator_NotCompromisedPasswordService.php';
require __DIR__.'/ContainerXaSGAQg/getValidator_NoSuspiciousCharactersService.php';
require __DIR__.'/ContainerXaSGAQg/getValidator_ExpressionLanguageService.php';
require __DIR__.'/ContainerXaSGAQg/getValidator_ExpressionService.php';
require __DIR__.'/ContainerXaSGAQg/getValidator_EmailService.php';
require __DIR__.'/ContainerXaSGAQg/getTwig_Runtime_SerializerService.php';
require __DIR__.'/ContainerXaSGAQg/getTwig_Runtime_SecurityCsrfService.php';
require __DIR__.'/ContainerXaSGAQg/getTwig_Runtime_ImportmapService.php';
require __DIR__.'/ContainerXaSGAQg/getTwig_Runtime_HttpkernelService.php';
require __DIR__.'/ContainerXaSGAQg/getTwig_Mailer_MessageListenerService.php';
require __DIR__.'/ContainerXaSGAQg/getTwig_Form_RendererService.php';
require __DIR__.'/ContainerXaSGAQg/getTwig_Form_EngineService.php';
require __DIR__.'/ContainerXaSGAQg/getTurbo_Twig_RuntimeService.php';
require __DIR__.'/ContainerXaSGAQg/getTurbo_Doctrine_EventListenerService.php';
require __DIR__.'/ContainerXaSGAQg/getTranslation_Loader_YmlService.php';
require __DIR__.'/ContainerXaSGAQg/getTranslation_Loader_XliffService.php';
require __DIR__.'/ContainerXaSGAQg/getTranslation_Loader_ResService.php';
require __DIR__.'/ContainerXaSGAQg/getTranslation_Loader_QtService.php';
require __DIR__.'/ContainerXaSGAQg/getTranslation_Loader_PoService.php';
require __DIR__.'/ContainerXaSGAQg/getTranslation_Loader_PhpService.php';
require __DIR__.'/ContainerXaSGAQg/getTranslation_Loader_MoService.php';
require __DIR__.'/ContainerXaSGAQg/getTranslation_Loader_JsonService.php';
require __DIR__.'/ContainerXaSGAQg/getTranslation_Loader_IniService.php';
require __DIR__.'/ContainerXaSGAQg/getTranslation_Loader_DatService.php';
require __DIR__.'/ContainerXaSGAQg/getTranslation_Loader_CsvService.php';
require __DIR__.'/ContainerXaSGAQg/getTexter_TransportsService.php';
require __DIR__.'/ContainerXaSGAQg/getStimulus_UxControllersTwigRuntimeService.php';
require __DIR__.'/ContainerXaSGAQg/getStimulus_AssetMapper_LoaderJavascriptCompilerService.php';
require __DIR__.'/ContainerXaSGAQg/getStimulus_AssetMapper_ControllersMapGeneratorService.php';
require __DIR__.'/ContainerXaSGAQg/getSession_Handler_NativeService.php';
require __DIR__.'/ContainerXaSGAQg/getSession_FactoryService.php';
require __DIR__.'/ContainerXaSGAQg/getServicesResetterService.php';
require __DIR__.'/ContainerXaSGAQg/getSecurity_Validator_UserPasswordService.php';
require __DIR__.'/ContainerXaSGAQg/getSecurity_RouteLoader_LogoutService.php';
require __DIR__.'/ContainerXaSGAQg/getSecurity_PasswordHasherFactoryService.php';
require __DIR__.'/ContainerXaSGAQg/getSecurity_Logout_Listener_CsrfTokenClearingService.php';
require __DIR__.'/ContainerXaSGAQg/getSecurity_Listener_UserProviderService.php';
require __DIR__.'/ContainerXaSGAQg/getSecurity_Listener_UserChecker_MainService.php';
require __DIR__.'/ContainerXaSGAQg/getSecurity_Listener_Session_MainService.php';
require __DIR__.'/ContainerXaSGAQg/getSecurity_Listener_PasswordMigratingService.php';
require __DIR__.'/ContainerXaSGAQg/getSecurity_Listener_Main_UserProviderService.php';
require __DIR__.'/ContainerXaSGAQg/getSecurity_Listener_CsrfProtectionService.php';
require __DIR__.'/ContainerXaSGAQg/getSecurity_Listener_CheckAuthenticatorCredentialsService.php';
require __DIR__.'/ContainerXaSGAQg/getSecurity_Firewall_Map_Context_MainService.php';
require __DIR__.'/ContainerXaSGAQg/getSecurity_Firewall_Map_Context_DevService.php';
require __DIR__.'/ContainerXaSGAQg/getSecurity_Csrf_TokenStorageService.php';
require __DIR__.'/ContainerXaSGAQg/getSecurity_Csrf_TokenManagerService.php';
require __DIR__.'/ContainerXaSGAQg/getSecurity_ChannelListenerService.php';
require __DIR__.'/ContainerXaSGAQg/getSecurity_AccessListenerService.php';
require __DIR__.'/ContainerXaSGAQg/getSecrets_VaultService.php';
require __DIR__.'/ContainerXaSGAQg/getRouting_LoaderService.php';
require __DIR__.'/ContainerXaSGAQg/getPropertyInfo_SerializerExtractorService.php';
require __DIR__.'/ContainerXaSGAQg/getNotifier_TransportFactory_NullService.php';
require __DIR__.'/ContainerXaSGAQg/getMonolog_Logger_MessengerService.php';
require __DIR__.'/ContainerXaSGAQg/getMonolog_Logger_MailerService.php';
require __DIR__.'/ContainerXaSGAQg/getMonolog_Logger_DeprecationService.php';
require __DIR__.'/ContainerXaSGAQg/getMonolog_Logger_AssetMapperService.php';
require __DIR__.'/ContainerXaSGAQg/getMessenger_TransportFactoryService.php';
require __DIR__.'/ContainerXaSGAQg/getMessenger_Transport_Sync_FactoryService.php';
require __DIR__.'/ContainerXaSGAQg/getMessenger_Transport_FailedService.php';
require __DIR__.'/ContainerXaSGAQg/getMessenger_Transport_Doctrine_FactoryService.php';
require __DIR__.'/ContainerXaSGAQg/getMessenger_Transport_AsyncService.php';
require __DIR__.'/ContainerXaSGAQg/getMessenger_RoutableMessageBusService.php';
require __DIR__.'/ContainerXaSGAQg/getMessenger_Retry_SendFailedMessageForRetryListenerService.php';
require __DIR__.'/ContainerXaSGAQg/getMessenger_Retry_MultiplierRetryStrategy_FailedService.php';
require __DIR__.'/ContainerXaSGAQg/getMessenger_Retry_MultiplierRetryStrategy_AsyncService.php';
require __DIR__.'/ContainerXaSGAQg/getMessenger_Listener_StopWorkerOnRestartSignalListenerService.php';
require __DIR__.'/ContainerXaSGAQg/getMessenger_Failure_SendFailedMessageToFailureTransportListenerService.php';
require __DIR__.'/ContainerXaSGAQg/getMessenger_Bus_Default_Middleware_TraceableService.php';
require __DIR__.'/ContainerXaSGAQg/getMessenger_Bus_Default_Middleware_SendMessageService.php';
require __DIR__.'/ContainerXaSGAQg/getMessenger_Bus_Default_Middleware_HandleMessageService.php';
require __DIR__.'/ContainerXaSGAQg/getMailer_TransportsService.php';
require __DIR__.'/ContainerXaSGAQg/getMailer_TransportFactory_SmtpService.php';
require __DIR__.'/ContainerXaSGAQg/getMailer_TransportFactory_SendmailService.php';
require __DIR__.'/ContainerXaSGAQg/getMailer_TransportFactory_NullService.php';
require __DIR__.'/ContainerXaSGAQg/getMailer_TransportFactory_NativeService.php';
require __DIR__.'/ContainerXaSGAQg/getFragment_Renderer_InlineService.php';
require __DIR__.'/ContainerXaSGAQg/getErrorHandler_ErrorRenderer_HtmlService.php';
require __DIR__.'/ContainerXaSGAQg/getErrorControllerService.php';
require __DIR__.'/ContainerXaSGAQg/getDoctrine_UuidGeneratorService.php';
require __DIR__.'/ContainerXaSGAQg/getDoctrine_UlidGeneratorService.php';
require __DIR__.'/ContainerXaSGAQg/getDoctrine_Orm_Validator_UniqueService.php';
require __DIR__.'/ContainerXaSGAQg/getDoctrine_Orm_Messenger_EventSubscriber_DoctrineClearEntityManagerService.php';
require __DIR__.'/ContainerXaSGAQg/getDoctrine_Orm_Messenger_DoctrineSchemaListenerService.php';
require __DIR__.'/ContainerXaSGAQg/getDoctrine_Orm_Listeners_PdoSessionHandlerSchemaListenerService.php';
require __DIR__.'/ContainerXaSGAQg/getDoctrine_Orm_Listeners_LockStoreSchemaListenerService.php';
require __DIR__.'/ContainerXaSGAQg/getDoctrine_Orm_Listeners_DoctrineTokenProviderSchemaListenerService.php';
require __DIR__.'/ContainerXaSGAQg/getDoctrine_Orm_Listeners_DoctrineDbalCacheAdapterSchemaListenerService.php';
require __DIR__.'/ContainerXaSGAQg/getDoctrine_Orm_DefaultListeners_AttachEntityListenersService.php';
require __DIR__.'/ContainerXaSGAQg/getDoctrine_Orm_DefaultEntityManager_PropertyInfoExtractorService.php';
require __DIR__.'/ContainerXaSGAQg/getDebug_Security_Voter_VoteListenerService.php';
require __DIR__.'/ContainerXaSGAQg/getDebug_Security_Firewall_Authenticator_MainService.php';
require __DIR__.'/ContainerXaSGAQg/getDebug_FileLinkFormatter_UrlFormatService.php';
require __DIR__.'/ContainerXaSGAQg/getDebug_ErrorHandlerConfiguratorService.php';
require __DIR__.'/ContainerXaSGAQg/getDataCollector_Request_SessionCollectorService.php';
require __DIR__.'/ContainerXaSGAQg/getController_TemplateAttributeListenerService.php';
require __DIR__.'/ContainerXaSGAQg/getContainer_GetenvService.php';
require __DIR__.'/ContainerXaSGAQg/getContainer_GetRoutingConditionServiceService.php';
require __DIR__.'/ContainerXaSGAQg/getContainer_EnvVarProcessorsLocatorService.php';
require __DIR__.'/ContainerXaSGAQg/getContainer_EnvVarProcessorService.php';
require __DIR__.'/ContainerXaSGAQg/getCache_SystemClearerService.php';
require __DIR__.'/ContainerXaSGAQg/getCache_GlobalClearerService.php';
require __DIR__.'/ContainerXaSGAQg/getCache_AppClearerService.php';
require __DIR__.'/ContainerXaSGAQg/getAssetMapper_Importmap_GeneratorService.php';
require __DIR__.'/ContainerXaSGAQg/getAssetMapper_Importmap_ConfigReaderService.php';
require __DIR__.'/ContainerXaSGAQg/getAssetMapper_Compiler_JavascriptImportPathCompilerService.php';
require __DIR__.'/ContainerXaSGAQg/getAssetMapper_Compiler_CssAssetUrlCompilerService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_Validator_State_ErrorProviderService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_SwaggerUi_ProcessorService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_SwaggerUi_ContextService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_SwaggerUi_ActionService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_StateProvider_ObjectService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_StateProvider_Documentation_ContentNegotiationService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_StateProvider_CreateService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_StateProcessor_LocatorService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_StateProcessor_Documentation_WriteService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_State_ErrorProviderService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_Serializer_FilterParameterProviderService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_Openapi_ProviderService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_Metadata_PropertySchema_OneOfRestrictionService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_Metadata_PropertySchema_CollectionRestrictionService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_Listener_View_WriteService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_Listener_View_ValidateService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_Listener_View_SerializeService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_Listener_View_RespondService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_Listener_ExceptionService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_Jsonld_Action_ContextService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_HttpCache_Processor_AddHeadersService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_Doctrine_Orm_State_RemoveProcessorService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_Doctrine_Orm_State_PersistProcessorService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_Doctrine_Orm_State_ItemProviderService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_Doctrine_Orm_State_CollectionProviderService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_Doctrine_Orm_QueryExtension_PaginationService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_Doctrine_Orm_QueryExtension_FilterEagerLoadingService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_Doctrine_Orm_QueryExtension_FilterService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_Doctrine_Orm_QueryExtension_EagerLoadingService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_Doctrine_Orm_LinksHandlerService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_Doctrine_Orm_Extension_ParameterExtensionService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_Action_PlaceholderService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_Action_NotFoundService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_Action_NotExposedService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_Action_ExceptionService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_Action_ErrorPageService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_Action_EntrypointService.php';
require __DIR__.'/ContainerXaSGAQg/getApiPlatform_Action_DocumentationService.php';
require __DIR__.'/ContainerXaSGAQg/getAnnotatedAppEntityShoppinglistApiPlatformDoctrineOrmFilterSearchFilterService.php';
require __DIR__.'/ContainerXaSGAQg/getTemplateControllerService.php';
require __DIR__.'/ContainerXaSGAQg/getRedirectControllerService.php';
require __DIR__.'/ContainerXaSGAQg/getProfilerControllerService.php';
require __DIR__.'/ContainerXaSGAQg/getShoppinglistPostProcessorService.php';
require __DIR__.'/ContainerXaSGAQg/getShoppinglistRepositoryService.php';
require __DIR__.'/ContainerXaSGAQg/getProductRepositoryService.php';
require __DIR__.'/ContainerXaSGAQg/getProcessorService.php';
require __DIR__.'/ContainerXaSGAQg/get_ServiceLocator_Y4Zrx_Service.php';
require __DIR__.'/ContainerXaSGAQg/get_ServiceLocator_Qssr6JIService.php';
require __DIR__.'/ContainerXaSGAQg/get_ServiceLocator_C7f47p7Service.php';
require __DIR__.'/ContainerXaSGAQg/get_ServiceLocator_HBdvAhpService.php';
require __DIR__.'/ContainerXaSGAQg/get_Security_RequestMatcher_KLbKLHaService.php';
require __DIR__.'/ContainerXaSGAQg/get_Messenger_HandlerDescriptor_VMw0m61Service.php';
require __DIR__.'/ContainerXaSGAQg/get_Messenger_HandlerDescriptor_TGvt0LHService.php';
require __DIR__.'/ContainerXaSGAQg/get_Messenger_HandlerDescriptor_P4QvabmService.php';
require __DIR__.'/ContainerXaSGAQg/get_Messenger_HandlerDescriptor_KEzMhfsService.php';
require __DIR__.'/ContainerXaSGAQg/get_Messenger_HandlerDescriptor_XZowc_TService.php';
require __DIR__.'/ContainerXaSGAQg/get_Messenger_HandlerDescriptor_QXXNQ9dService.php';
require __DIR__.'/ContainerXaSGAQg/get_Messenger_HandlerDescriptor_Lml2ICsService.php';
require __DIR__.'/ContainerXaSGAQg/get_Messenger_HandlerDescriptor_6kVvRT_Service.php';
require __DIR__.'/ContainerXaSGAQg/get_Debug_ValueResolver_Security_UserValueResolverService.php';
require __DIR__.'/ContainerXaSGAQg/get_Debug_ValueResolver_Security_SecurityTokenValueResolverService.php';
require __DIR__.'/ContainerXaSGAQg/get_Debug_ValueResolver_Doctrine_Orm_EntityValueResolverService.php';
require __DIR__.'/ContainerXaSGAQg/get_Debug_ValueResolver_ArgumentResolver_VariadicService.php';
require __DIR__.'/ContainerXaSGAQg/get_Debug_ValueResolver_ArgumentResolver_UidService.php';
require __DIR__.'/ContainerXaSGAQg/get_Debug_ValueResolver_ArgumentResolver_SessionService.php';
require __DIR__.'/ContainerXaSGAQg/get_Debug_ValueResolver_ArgumentResolver_ServiceService.php';
require __DIR__.'/ContainerXaSGAQg/get_Debug_ValueResolver_ArgumentResolver_RequestPayloadService.php';
require __DIR__.'/ContainerXaSGAQg/get_Debug_ValueResolver_ArgumentResolver_RequestAttributeService.php';
require __DIR__.'/ContainerXaSGAQg/get_Debug_ValueResolver_ArgumentResolver_RequestService.php';
require __DIR__.'/ContainerXaSGAQg/get_Debug_ValueResolver_ArgumentResolver_QueryParameterValueResolverService.php';
require __DIR__.'/ContainerXaSGAQg/get_Debug_ValueResolver_ArgumentResolver_NotTaggedControllerService.php';
require __DIR__.'/ContainerXaSGAQg/get_Debug_ValueResolver_ArgumentResolver_DefaultService.php';
require __DIR__.'/ContainerXaSGAQg/get_Debug_ValueResolver_ArgumentResolver_DatetimeService.php';
require __DIR__.'/ContainerXaSGAQg/get_Debug_ValueResolver_ArgumentResolver_BackedEnumResolverService.php';
require __DIR__.'/ContainerXaSGAQg/get_Debug_ValueResolver_ApiPlatform_ArgumentResolver_PayloadService.php';
require __DIR__.'/ContainerXaSGAQg/get_Debug_Security_Voter_Security_Access_SimpleRoleVoterService.php';
require __DIR__.'/ContainerXaSGAQg/get_Debug_Security_Voter_Security_Access_ExpressionVoterService.php';
require __DIR__.'/ContainerXaSGAQg/get_Debug_Security_Voter_Security_Access_AuthenticatedVoterService.php';
...
$classes[] = 'App\Repository\ShoppinglistRepository';
$classes[] = 'App\State\ShoppinglistPostProcessor';

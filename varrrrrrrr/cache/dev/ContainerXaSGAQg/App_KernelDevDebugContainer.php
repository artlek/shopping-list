...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = ($container->privates['api_platform.openapi.serializer_context_builder'] ?? self::getApiPlatform_Openapi_SerializerContextBuilderService($container));
        ...
        return $container->services['api_platform.state_provider.parameter_validator'] = new \ApiPlatform\Symfony\Validator\State\ParameterValidatorProvider(($container->privates['debug.validator'] ?? self::getDebug_ValidatorService($container)), new \ApiPlatform\State\Provider\ReadProvider(($container->privates['api_platform.state_provider.locator'] ?? self::getApiPlatform_StateProvider_LocatorService($container)), $a, ($container->privates['monolog.logger'] ?? self::getMonolog_LoggerService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('hCkt5guaxA', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mR5nBWPE4r', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pp-nx9EnEY', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Z0NzienThc', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.property'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GZeH4RrLex', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dc+UF-tXuU', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource_collection'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gf9YiSDvgR', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['api_platform.cache.route_name_resolver'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('OR-fA-kf-p', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getApiPlatform_FilterLocatorService($container)
    {
        return $container->privates['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'annotated_app_entity_shoppinglist_api_platform_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_shoppinglist_api_platform_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityShoppinglistApiPlatformDoctrineOrmFilterSearchFilterService', true],
        ], [
            'annotated_app_entity_shoppinglist_api_platform_doctrine_orm_filter_search_filter' => '?',
        ]);
    }
    ...
    protected static function getApiPlatform_Listener_Request_ReadService($container)
    {
        ...
        ])), ($container->privates['api_platform.openapi.factory'] ?? self::getApiPlatform_Openapi_FactoryService($container))), $b), $b), $c, NULL, ($container->privates['api_platform.uri_variables.converter'] ?? self::getApiPlatform_UriVariables_ConverterService($container)));
    }
    ...
    {
        return $container->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('T9qTnrqEpP', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('j5VmX8ER6M', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('1RXOdL8F9z', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1Ktul5iqIe', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2HBNEUL6p9', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xYy+-1AoX4', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDebug_SerializerService($container)
    {
        ...
        $p = new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($b, $c, $l, $m, $n, $d, $f, $j, $o, $container->parameters['api_platform.serializer.default_context'], $e, NULL);

        $q = new \ApiPlatform\JsonLd\Serializer\ErrorNormalizer($p, $container->parameters['api_platform.serializer.default_context']);
        $r = new \ApiPlatform\Serializer\ItemNormalizer($c, $l, $m, $n, $f, $j, $o, NULL, $b, $e, [], NULL);
        ...
        $v = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($o, $t, $f, $a, $u, NULL, [], $a);
        ...
        return $container->privates['debug.serializer'] = new \Symfony\Component\Serializer\Debug\TraceableSerializer(new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($f), $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($i, $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($i, $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Serializer\ConstraintViolationListNormalizer([], $j), $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer($k, [], $j, $container->parameters['api_platform.serializer.default_context']), $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Problem\Serializer\ConstraintViolationListNormalizer([], $j, $container->parameters['api_platform.serializer.default_context']), $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($i, $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($q, $j), $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($b, $c, $l, $n, $k, $j, $container->parameters['api_platform.serializer.default_context']), $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($b, $m, $k), $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\ErrorNormalizer($k, true, $container->parameters['api_platform.serializer.default_context']), $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($r, $j), $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Problem\Serializer\ErrorNormalizer(true, []), $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Messenger\Transport\Serialization\Normalizer\FlattenExceptionNormalizer(), $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($q, $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true, $container->parameters['api_platform.serializer.default_context'], $s), $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UidNormalizer($container->parameters['api_platform.serializer.default_context']), $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($p, $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($r, $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer($container->parameters['api_platform.serializer.default_context']), $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer($container->parameters['api_platform.serializer.default_context'], $t), $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($o, $t, $a, $u, NULL, [])), $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer($container->parameters['api_platform.serializer.default_context']), $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($container->privates['mime_types'] ?? self::getMimeTypesService($container))), $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\TranslatableNormalizer($s, $container->parameters['api_platform.serializer.default_context']), $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL, $container->parameters['api_platform.serializer.default_context']), $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($d, $n, $m, NULL, $container->parameters['api_platform.serializer.default_context']), 'page', 'pagination', $b, $f, 1, $container->parameters['api_platform.serializer.default_context']), $b, $n, ($container->privates['api_platform.filter_locator'] ?? self::getApiPlatform_FilterLocatorService($container)), $container->parameters['api_platform.serializer.default_context']), $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($v, $m, $d), $g), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($v, $g)], [new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\XmlEncoder($container->parameters['api_platform.serializer.default_context']), $g), new \Symfony\Component\Serializer\Debug\TraceableEncoder($h, $g), new \Symfony\Component\Serializer\Debug\TraceableEncoder($w, $g), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\CsvEncoder($container->parameters['api_platform.serializer.default_context']), $g), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\JsonEncoder('jsonopenapi', NULL), $g), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\YamlEncoder('yamlopenapi', $w), $g), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\JsonEncoder('jsonld', NULL), $g), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\JsonEncoder('jsonproblem'), $g)], $container->parameters['api_platform.serializer.default_context']), $g);
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Repository\\ShoppinglistRepository' => ['privates', 'App\\Repository\\ShoppinglistRepository', 'getShoppinglistRepositoryService', true],
        ], [
            'App\\Repository\\ProductRepository' => '?',
            'App\\Repository\\ShoppinglistRepository' => '?',
        ])));
